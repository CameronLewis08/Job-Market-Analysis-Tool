...
def test_parse_new_listing_markup_returns_expected_fields():
        ...
        <a class="listing-link--unlocked" href="/remote-jobs/acme-senior-data-engineer">
          <div class="new-listing">
            <div class="new-listing__header">
              ...
              <p class="new-listing__header__icons__date">12d</p>
            </div>
    ...
    assert listing["date_posted"] == (date.today() - timedelta(days=12)).isoformat()
...
def test_parse_new_listing_skips_jobs_older_than_14_days():
    html = """
    <ul>
